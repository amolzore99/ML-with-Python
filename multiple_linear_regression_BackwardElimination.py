...
dataset = pd.read_csv('H:/data analyst/excel/ML/50_Startups.csv')
...
Z = nm.append(arr = nm.ones((50,1)).astype(int), values=X, axis=1)
...
#importing datasets  
data_set= pd.read_csv('H:/data analyst/excel/ML/50_Startups.csv') 
